...
%>
	<div id="wrap" class="container">
		...
		<section class="content">
			<!-- 아티스트 정보 영역 -->
			<div class="d-flex border border-success p-4">
				<div class="mr-4">
			...
			<div>
				<table class="table text-center">
					...
					<tbody>
					<%
						for(Map<String, Object> name : musicList) {
							
					%>
					<tr>
						<td><%=name.get("id") %></td>
						<td><a href="/lesson02/quiz10_info.jsp?id=<%= name.get("id")%>"><%=name.get("title") %></a></td>
						<td><%=name.get("album") %></td>
					</tr>
					<% 
						}
					%>
